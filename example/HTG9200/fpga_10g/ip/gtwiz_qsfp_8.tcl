...
create_ip -name gtwizard_ultrascale -vendor xilinx.com -library ip -module_name gtwiz_qsfp_8

set_property -dict [list CONFIG.preset {GTY-10GBASE-R}] [get_ips gtwiz_qsfp_8]
